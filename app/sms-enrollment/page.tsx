      ...
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-4 leading-7 text-slate-700">
            Tendr helps homeowners receive SMS support for home warranty assistance, claim support,
            claim status updates, home maintenance reminders, and related product recommendations.
          </p>
          <p className="mt-3 leading-7 text-slate-700">
            SMS enrollment is optional. You do not need to enroll in Tendr SMS messages to purchase or
            use your home warranty services.
          </p>

          {statusMessage && (
            <p className={`mt-6 rounded-lg border px-4 py-3 text-sm ${statusMessage.tone}`}>
          ...
          <form className="mt-6 space-y-5" action="/api/sms-enrollment" method="post">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <label className="space-y-2 text-sm font-medium text-slate-700">
                Home System or Appliance Optional
                <input
                  name="homeSystemOrAppliance"
                  className="w-full rounded-lg border border-slate-300 px-3 py-2"
                  type="text"
                />
              </label>
