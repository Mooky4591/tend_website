    ...
    <main className="bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-5xl space-y-8 px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 rounded-xl border border-slate-200 bg-slate-50 p-4 sm:p-6">
            <form className="space-y-4" aria-label="Tendr SMS enrollment form mockup">
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="fullName">Full Name</label>
                <input id="fullName" type="text" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="Jane Homeowner" readOnly />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="mobilePhone">Mobile Phone Number</label>
                <input id="mobilePhone" type="tel" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="(555) 123-4567" readOnly />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="emailAddress">Email Address (optional)</label>
                <input id="emailAddress" type="email" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="jane@example.com" readOnly />
              </div>
              <div>
                <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="homeAddress">Home Address</label>
                <input id="homeAddress" type="text" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="123 Main St, Atlanta, GA" readOnly />
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="warrantyProvider">Warranty Provider</label>
                  <input id="warrantyProvider" type="text" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="Provider Name" readOnly />
                </div>
                <div>
                  <label className="mb-1 block text-sm font-medium text-slate-800" htmlFor="systemAppliance">Home System or Appliance</label>
                  <input id="systemAppliance" type="text" className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm" placeholder="HVAC" readOnly />
                </div>
              </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 rounded-xl border border-emerald-200 bg-emerald-50 p-5 sm:p-6">
            <p className="text-xl font-semibold text-emerald-900">Thank you</p>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 mx-auto max-w-md rounded-[2rem] border-8 border-slate-900 bg-slate-100 p-4 shadow-inner">
            <div className="rounded-2xl bg-white p-4">
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">SMS from Tendr</p>
